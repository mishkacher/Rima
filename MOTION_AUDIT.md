...
### Mobile
Главный UI-риск — fixed selector. Для третьего ряда он не должен превращаться в горизонтальную ленту. Решение: три независимые grid-строки по пять кнопок, safe-area, отдельный compact режим по высоте и автоматизированный width sweep 320/360/375/390/430 px.
